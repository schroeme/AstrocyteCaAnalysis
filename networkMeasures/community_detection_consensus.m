function [ncs,ncf,scs,scf,AR,Q_s,Q_f,S_s,S_f,AR_ag_af,AR_ag_as]=community_detection_consensus(A_spat,A_fxn,gamma_s,gamma_f,its,agroups)
...
agmat_spat = agreement(S_spat');
agmat_fxn = agreement(S_fxn');
S_s = consensus_und(agmat_spat,5,100);
S_f = consensus_und(agmat_fxn,5,100);
